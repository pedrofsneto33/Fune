  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-xl shadow-lg">
        <div className="flex justify-between items-center text-slate-600 dark:text-slate-500 dark:text-slate-400 text-xs font-semibold uppercase">
          <span>Vidas Cobertas</span>
          <span>👥</span>
        </div>
        <div className="mt-2 flex items-baseline gap-2">
          <span className="text-2xl font-bold text-slate-900 dark:text-white">{data?.totalLives || 0}</span>
          <span className="text-xs text-slate-600 dark:text-slate-500">({data?.activeContracts || 0} contratos)</span>
        </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-xl shadow-lg">
        ...
        <p className="text-xs text-slate-600 dark:text-slate-500 dark:text-slate-400 mt-1">Entradas em mensalidades</p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-xl shadow-lg">
        ...
        <p className="text-xs text-slate-600 dark:text-slate-500 dark:text-slate-400 mt-1">Atendimentos concluídos</p>
      </div>
    </div>
  );
}
