...
import { generateChargeWhatsAppUrl, WhatsAppChargePayload } from '@/lib/whatsapp';

interface Props extends WhatsAppChargePayload {
  className?: string;
}
...
export function WhatsAppChargeButton({
  ...
  const handleOpenWhatsApp = () => {
    const url = generateChargeWhatsAppUrl({
      holderName,
      phone,
      amount,
      dueDate,
