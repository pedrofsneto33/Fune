      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 w-full max-w-lg rounded-2xl p-6 shadow-2xl">
        <div className="flex justify-between items-center pb-4 border-b border-zinc-200 dark:border-zinc-800">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-bold text-slate-900 dark:text-white">Cadastrar Novo Associado</h3>
        ...
        <form onSubmit={onSave} className="space-y-4 text-xs mt-4">
          <div>
            <label className="block font-semibold text-zinc-700 dark:text-zinc-300 mb-1">Nome Completo do Titular *</label>
            <input
              type="text"
              required
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              <label className="block font-semibold text-zinc-700 dark:text-zinc-300 mb-1">CPF *</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block font-semibold text-zinc-700 dark:text-zinc-300 mb-1">WhatsApp / Telefone *</label>
              <input
                type="text"
                required
          ...
          <div>
            <label className="block font-semibold text-zinc-700 dark:text-zinc-300 mb-1">Plano Funerário *</label>
            <select
              value={selectedPlan}
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-zinc-200 dark:border-zinc-800">
            ...
            <button
              type="submit"
              disabled={saving}
              className="px-5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white dark:text-white font-semibold disabled:opacity-50"
            >
