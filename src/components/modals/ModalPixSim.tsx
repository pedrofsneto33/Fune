...
export function ModalPixSim({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-zinc-900 border border-amber-500/30 w-full max-w-md rounded-2xl p-6 shadow-2xl space-y-4">
        <div className="flex justify-between items-center pb-3 border-b border-zinc-800">
          <div className="flex items-center gap-2">
            <Zap className="w-5 h-5 text-amber-400" />
            <h3 className="text-base font-bold text-white">Simulador de Webhook PIX</h3>
          </div>
        ...
        <form onSubmit={onSimulate} className="space-y-4 text-xs">
          <div>
            <label className="block text-zinc-300 font-semibold mb-1">Selecione o Pagamento / Mensalidade</label>
            <select
          ...
          <div className="flex justify-end gap-3 pt-3 border-t border-zinc-800">
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl bg-amber-600 hover:bg-amber-500 text-white font-semibold disabled:opacity-50"
            >
