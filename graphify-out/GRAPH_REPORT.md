...
6. `notifyError()` - 55 edges
7. `authFetch()` - 53 edges
8. `react` - 45 edges
9. `search()` - 43 edges
...
Cohesion: 0.06
Nodes (40): RFC-5322, GET, PATCH, POST, DELETE, GET, PATCH, POST (+32 more)

### Community 2 - "supabaseAdmin"
Cohesion: 0.17
Nodes (17): GET, getTenantUsage(), PATCH, POST, VALID_PLAN_CODES, markWebhookEvent(), POST(), POST (+9 more)
...
Cohesion: 0.14
Nodes (22): ContratosPage(), isContractActive(), DependentesPage(), VALID_RELATIONS, ImportarTitularesPage(), ImportResult, InvalidRow, TitularesPage() (+14 more)
...
Cohesion: 0.09
Nodes (34): dynamic, POST, POST, BatchResult, contractIsActive(), holderIsInactive(), POST, withTimeout() (+26 more)
...
Cohesion: 0.09
Nodes (30): GET, DELETE, dynamic, GET, POST, POST(), DELETE, dynamic (+22 more)
...
Cohesion: 0.19
Nodes (8): LogisticsTab(), ServiceOrdersTab(), CollectorRoute, Dispatch, DispatchAuditLog, Partner, ServiceOrder, ServiceOrderItem
...
Cohesion: 0.13
Nodes (13): lucide-react, ADDONS, FAQ, MODULES, PLANS, brl(), CarnetRow, contractIsActive() (+5 more)
...
Cohesion: 0.10
Nodes (20): recharts, FormHoldersQuick, FormInventoryItem, FormVehicle, NovaOrdemPage(), OrdemItem, FinancialSummary, ModalDRE() (+12 more)
...
### Community 96 - "react"
Cohesion: 0.12
Nodes (12): react, BenefitsTab(), EMPTY_FORM, EMPTY_FORM, InventoryTab(), EMPTY_FORM, ThanatopraxyTab(), InventoryItem (+4 more)
...
Cohesion: 0.05
Nodes (41): dynamic, POST, dynamic, GET, POST, dynamic, POST, dynamic (+33 more)
...
## Knowledge Gaps
- **1398 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+1393 more)
...
- **Why does `search()` connect `search` to `validate_data.py`, `BM25`, `design_system.py`, `Search Domain Detection`, `_normalize`, `Public Identity Resolver`, `scripts/core.py`, `.generate`, `Text Layout Resilience Tests`?**
