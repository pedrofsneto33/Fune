...
## Communities (381 total, 138 thin omitted)
...
Cohesion: 0.08
Nodes (37): ContratosPage(), isContractActive(), DependentesPage(), VALID_RELATIONS, FormHoldersQuick, FormInventoryItem, FormVehicle, NovaOrdemPage() (+29 more)
...
Cohesion: 0.06
Nodes (38): recharts, Burial, BURIAL_STATUS_STYLE, burialStatusClass(), ChapelBooking, Contract, ConvalescenceItem, Dependent (+30 more)
...
Cohesion: 0.10
Nodes (18): lucide-react, ModalWebhookRetry(), Props, WebhookEvent, ModalCobrancaAvulsa(), FiscalConfigData, FiscalSettingsSection(), fmtPercent() (+10 more)
...
Cohesion: 0.07
Nodes (24): AuditLogsTab(), detailsText(), ExecutiveTab(), fmtBRL(), FinancialTab(), fmtBRL(), ReservePayload, LogisticsTab() (+16 more)
...
Cohesion: 0.15
Nodes (14): brl(), CarnetRow, contractIsActive(), HolderContract, holderIsInactive(), HolderRow, ModalCarnets(), STATUS_STYLE (+6 more)
...
- **Why does `react` connect `react` to `domain.ts`, `FiscalTab.tsx`, `notifyError`, `BillingTab.tsx`, `CrmTab.tsx`, `AccountsPayableTab.tsx`, `app/page.tsx`, `ChapelTab.tsx`, `PlansTab.tsx`, `package.json`, `app/layout.tsx`, `notifySuccess`?**
